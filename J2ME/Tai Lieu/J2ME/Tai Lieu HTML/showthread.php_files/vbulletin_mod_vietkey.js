...
// Set id for vietkey program tool bar 'p-tb'
toolbarid="auto,telex,vni,viqr,off,ckspell,old".split(",")
...
function findC(w,k,sf) {
	if((mod==3)&&(w.substr(w.length-1,1)=="\\")) return new Array(1,k.charCodeAt(0))
